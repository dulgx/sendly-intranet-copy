...
export default function VideoZaavar() {
  return (
    <div className="flex">
      <div class="relative flex h-[calc(96vh-2rem)] w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
        <div class="p-4 mb-2">
